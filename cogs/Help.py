...
HELP_ICON = "https://cdn0.iconfinder.com/data/icons/cosmo-symbols/40/help_1-512.png"
...
class Help(commands.Cog):
  ...
  async def help(self, ctx):
    ...
    embed.add_field(
      ...
      value=
      "balance, beg, daily, deposit, steal, send, rob, job, listjob, work, inventory, dig, sell, leaderboard",
      inline=True)
  ...
  async def mood(self, ctx):
    ...
    Extended command for help
    """
    embed = discord.Embed(title="$mood",
  ...
  async def inspire(self, ctx):
    ...
    Extended command for help
    """
    embed = discord.Embed(title="$inspire",
  ...
  async def pfp(self, ctx):
    ...
    Extended command for help
    """
    embed = discord.Embed(title="$pfp <@user>",
  ...
  async def delete(self, ctx):
    ...
    embed = discord.Embed(
      title="$delete <num>",
      description=
      "Delete num of message(s) on the channel. Default delete limit set to 5.",
      color=discord.Colour.blurple())
    embed.set_thumbnail(
      url=HELP_ICON)
    await ctx.channel.send(embed=embed)
  ...
  async def kick(self, ctx):
    ...
    Extended command for help
    """
    embed = discord.Embed(title="$kick <@user>",
  ...
  async def ban(self, ctx):
    ...
    Extended command for help
    """
    embed = discord.Embed(title="$ban <@user>",
  ...
  async def steal(self, ctx):
    ...
    Extended command for help
    """
    embed = discord.Embed(title="$steal <@user>",
  ...
  async def job(self, ctx):
    ...
    Extended command for help
    """
    embed = discord.Embed(title="$job <position>",
  ...
  async def iq(self, ctx):
    ...
    embed = discord.Embed(
      title="$iq",
      description=
      "Randomly give an IQ score for the user who invoke the command",
      color=discord.Colour.blurple())
    embed.set_thumbnail(
      url=HELP_ICON)
    await ctx.channel.send(embed=embed)
